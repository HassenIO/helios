...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { endDate: @rent.endDate, startDate: @rent.startDate, travel: @rent.travel, user: @rent.user }
    end
  ...
  test "should update rent" do
    put :update, id: @rent, rent: { endDate: @rent.endDate, startDate: @rent.startDate, travel: @rent.travel, user: @rent.user }
    assert_redirected_to rent_path(assigns(:rent))
  end
