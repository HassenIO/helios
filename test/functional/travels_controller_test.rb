...
class TravelsControllerTest < ActionController::TestCase
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post :create, travel: { airPortName: @travel.airPortName, arrival: @travel.arrival, departure: @travel.departure }
    end
  ...
  test "should update travel" do
    put :update, id: @travel, travel: { airPortName: @travel.airPortName, arrival: @travel.arrival, departure: @travel.departure }
    assert_redirected_to travel_path(assigns(:travel))
  end
